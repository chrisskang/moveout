    ...
    <>
      <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <Card key={item.title} className="relative overflow-hidden">
            {item.reserved ?
            item.sold ?
              (<div className="absolute top-5 right-5 bg-red-500 text-2xl text-center  text-white py-1 px-20 transform rotate-45 translate-x-[30%] translate-y-[30%] z-10">
                Sold
              </div>)

              : (<div className="absolute top-8 right-5 bg-orange-500 text-2xl text-center text-white py-1 px-20 transform rotate-45 translate-x-[30%] translate-y-[30%] z-10">
                Reserved
              </div>)
            : null
